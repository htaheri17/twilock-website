...
The production origin is configured as `https://twilock.com`. The site is fully static and the repository root is the publishable output; there is no build command, framework server, database, or environment secret.

## Connect the repository

1. Sign in to Porkbun and open **Domain Management** for `twilock.com`.
...
- `https://twilock.com/`
- `https://twilock.com/twilock-vs-opal/`
- `https://twilock.com/best-strict-app-blockers-iphone/`
- `https://twilock.com/privacy/`
- `https://twilock.com/robots.txt`
- `https://twilock.com/sitemap.xml`
...
Run it only after `https://twilock.com` resolves publicly.

## Submit the sitemap

In Google Search Console, add or select the `twilock.com` property and submit:
